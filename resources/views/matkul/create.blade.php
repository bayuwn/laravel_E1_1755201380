...
<div class="form-group row">
  ...
  <div class="col-sm-5">
  <input type="text" name="sks" class="form-control" id="sks" placeholder="Masukan SKS mata kuliah">
    @error('sks')
...
<div class="form-group row">
  ...
  <div class="col-sm-5">
  <input type="text" name="semester" class="form-control" id="semester" placeholder="Masukan semester mata kuliah">
    @error('semester')
